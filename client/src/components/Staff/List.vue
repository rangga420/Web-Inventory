<template>
  <div class="row align-items-center">
    <div class="border-0 mb-4">
      ...
      >
        <h3 class="fw-bold mb-0">Staff Information</h3>
        <div class="col-auto d-flex w-sm-100">
          ...
          >
            <i class="icofont-plus-circle me-2 fs-6"></i>Add Customers
          </button>
        </div>
      </div>
    </div>
